...
import com.example.utsandroidpemrogramanandroid310121273akhsalavrilkusumaa.R
import com.example.utsandroidpemrogramanandroid310121273akhsalavrilkusumaa.R.*
import java.util.*

class MainActivity : AppCompatActivity() {
//10121273 Akhsa Lavril Kusuma
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(layout.activity_main)

        val editTextDateConfirmed: EditText = findViewById(id.editTextDateConfirmed)
        val editTextDOB: EditText = findViewById(id.editTextDOB)
        val editTextNIK: EditText = findViewById(id.editTextNIK)
        val editTextName: EditText = findViewById(id.editTextName)

        val radioGroupTestType: RadioGroup = findViewById(id.radioGroupTestType)
        val radioGroupGender: RadioGroup = findViewById(id.radioGroupGender)
        val radioGroupRelationship: RadioGroup = findViewById(id.radioGroupRelationship)

        val checkBoxConfirm: CheckBox = findViewById(id.checkBoxConfirm)
        ...
        val buttonNext: Button = findViewById(id.buttonNext)
